...
class Deck:
    ...
    standard_deck = [Card(Rank.ace, Suit.clubs), Card(Rank.two, Suit.clubs), Card(Rank.three, Suit.clubs), Card(Rank.four, Suit.clubs), Card(Rank.five, Suit.clubs), Card(Rank.six, Suit.clubs), Card(Rank.seven, Suit.clubs), Card(Rank.eight, Suit.clubs), Card(Rank.nine, Suit.clubs), Card(Rank.ten, Suit.clubs), Card(Rank.jack, Suit.clubs), Card(Rank.queen, Suit.clubs), Card(Rank.king, Suit.clubs),
                     Card(Rank.ace, Suit.diamonds), Card(Rank.two, Suit.diamonds), Card(Rank.three, Suit.diamonds), Card(Rank.four, Suit.diamonds), Card(Rank.five, Suit.diamonds), Card(Rank.six, Suit.diamonds), Card(Rank.seven, Suit.diamonds), Card(Rank.eight, Suit.diamonds), Card(Rank.nine, Suit.diamonds), Card(Rank.ten, Suit.diamonds), Card(Rank.jack, Suit.diamonds), Card(Rank.queen, Suit.diamonds), Card(Rank.king, Suit.diamonds),
                     Card(Rank.ace, Suit.hearts), Card(Rank.two, Suit.hearts), Card(Rank.three, Suit.hearts), Card(Rank.four, Suit.hearts), Card(Rank.five, Suit.hearts), Card(Rank.six, Suit.hearts), Card(Rank.seven, Suit.hearts), Card(Rank.eight, Suit.hearts), Card(Rank.nine, Suit.hearts), Card(Rank.ten, Suit.hearts), Card(Rank.jack, Suit.hearts), Card(Rank.queen, Suit.hearts), Card(Rank.king, Suit.hearts),
